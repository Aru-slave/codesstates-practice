...
public class Kiosk_Program {
  ...
  static void cost(int number) {
    ...
    //TODO:
    if(menu_count <= 0 || menu_count > 99) {
      System.out.println(String.format("[경고]%d개는 입력하실 수 없습니다.", menu_count));
  ...
  static void output_print(int result) {
    //TODO:
    System.out.println(String.format("[안내]주문하신 총 금액은 %d원 입니다.",result));
